...
#ifndef MY_SRV__SRV__DETAIL__ADD__FUNCTIONS_H_
#define MY_SRV__SRV__DETAIL__ADD__FUNCTIONS_H_
 ...
 * )) before or use
 * my_srv__srv__Add_Request__create()
 ...
 * calls
 * my_srv__srv__Add_Request__init().
...
/**
 * It calls
 * my_srv__srv__Add_Request__fini()
...
/**
 * It calls
 * my_srv__srv__Add_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * my_srv__srv__Add_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_my_srv
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_srv__srv__Add_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_srv
...
/**
 * It calls
 * my_srv__srv__Add_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_srv
...
/**
 * It calls
 * my_srv__srv__Add_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * my_srv__srv__Add_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_my_srv
...
/**
 * It allocates the memory for the array and calls
 * my_srv__srv__Add_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_srv
...
/**
 * It calls
 * my_srv__srv__Add_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_SRV__SRV__DETAIL__ADD__FUNCTIONS_H_
