...
def generate_launch_description():
    ...
    enable_label_sorting = DeclareLaunchArgument(
        'enable_label_sorting', default_value='false',
        description='启动 depth_label_sorting_node 标签分拣')
    enable_label_stack = DeclareLaunchArgument(
        'enable_label_stack', default_value='false',
        description='启动 depth_label_stack_node 标签码垛')
    enable_label_track = DeclareLaunchArgument(
        'enable_label_track', default_value='false',
        description='启动 depth_label_track_node 标签追踪')
    enable_num_sorting = DeclareLaunchArgument(
        'enable_num_sorting', default_value='false',
        description='启动 depth_num_sorting_node 数字分拣')
    enable_num_stack = DeclareLaunchArgument(
        'enable_num_stack', default_value='false',
        description='启动 depth_num_stack_node 数字码垛')
    enable_num_track = DeclareLaunchArgument(
        'enable_num_track', default_value='false',
        description='启动 depth_num_track_node 数字追踪')
    ...
    ld.add_action(Node(
        package='my_srv',
        executable='depth_label_stack_node.py',
        name='depth_label_stack_node',
        output='screen',
    ))

    ld.add_action(Node(
        package='my_srv',
        executable='depth_label_track_node.py',
        name='depth_label_track_node',
        output='screen',
    ))
    ...
    ld.add_action(Node(
        package='my_srv',
        executable='depth_num_stack_node.py',
        name='depth_num_stack_node',
        output='screen',
    ))

    ld.add_action(Node(
        package='my_srv',
        executable='depth_num_track_node.py',
        name='depth_num_track_node',
        output='screen',
    ))
