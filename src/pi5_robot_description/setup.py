...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/config', glob('config/*.txt')),
    ...
    entry_points={
        'console_scripts': [
            ...
            'arm_fixed_pose_node = pi5_robot_description.arm_fixed_pose_node:main',
            'depth_convert_node = pi5_robot_description.depth_convert_node:main',
            'nav_pick_place_node = pi5_robot_description.nav_pick_place_node:main',
            'waypoint_recorder_node = pi5_robot_description.waypoint_recorder_node:main',
        ],
    },
)
