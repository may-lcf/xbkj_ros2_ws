...
static const _Add_Request_type_support_symbol_names_t _Add_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_srv, srv, Add_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_srv, srv, Add_Request)),
  }
};
...
{
  return &::my_srv::srv::rosidl_typesupport_cpp::Add_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_srv, srv, Add_Request)() {
  return get_message_type_support_handle<my_srv::srv::Add_Request>();
}
...
static const _Add_Response_type_support_symbol_names_t _Add_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_srv, srv, Add_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_srv, srv, Add_Response)),
  }
};
...
{
  return &::my_srv::srv::rosidl_typesupport_cpp::Add_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_srv, srv, Add_Response)() {
  return get_message_type_support_handle<my_srv::srv::Add_Response>();
}
...
static const _Add_Event_type_support_symbol_names_t _Add_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_srv, srv, Add_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_srv, srv, Add_Event)),
  }
};
...
{
  return &::my_srv::srv::rosidl_typesupport_cpp::Add_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_srv, srv, Add_Event)() {
  return get_message_type_support_handle<my_srv::srv::Add_Event>();
}
...
static const _Add_type_support_symbol_names_t _Add_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_srv, srv, Add)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_srv, srv, Add)),
  }
};
...
static const rosidl_service_type_support_t Add_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<my_srv::srv::Add_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<my_srv::srv::Add_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<my_srv::srv::Add_Event>(),
...
{
  return &::my_srv::srv::rosidl_typesupport_cpp::Add_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, my_srv, srv, Add)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<my_srv::srv::Add>();
}
